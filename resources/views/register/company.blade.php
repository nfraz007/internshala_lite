			...
			<div id="student" class="col s12 m12 l8 offset-l2">
		    	...
		    	<form action="{{ $action }}" method="POST">
		    		<div class="input-field">
			          <input type="text" name="company_name" value="@isset($company_name) {{ $company_name }} @endisset" class="@if($errors->has('company_name')) invalid @endif" required>
			          <label>Company Name</label>
			          <small class="red-text">@if($errors->has('company_name')) {{ $errors->first('company_name') }} @endif</small>
			        </div>
			    	<div class="input-field">
