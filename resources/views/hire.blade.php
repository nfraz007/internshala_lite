	...
	<div class="row pd30">
		<form action="{{ URL('hire') }}" method="GET">
	        ...
	        <div class="col s12 m3 l3 center-align">
	        	...
	        	<a class="waves-effect waves-light btn white black-text" href="{{ URL('hire/save') }}">Add</a>
	        </div>
	    </form>
	</div>
</div>
			...
			<div class="col s12 m12 l12 card">
				<div class="row">
					<div class="col s12 m6 l6">
						...
						<a class="waves-effect waves-light btn" href="{{ $internship['href_view'] }}">View</a>
						<a class="waves-effect waves-light btn" href="{{ $internship['href_edit'] }}">Edit</a>
